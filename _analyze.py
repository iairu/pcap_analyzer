...
class Analyze:
    ...
    class Eth_stds:
        ...
        UNKNOWN = "Unknown"
        NOVELL_802_3_RAW = "Novell 802.3 RAW"           # todo: check 802.2 802.3 if correct minor ver.
    ...
    class __Dict__:
        saps = { # todo: nacitat zo suboru
            ...
            0x0E: "PROWAY (IEC 955) Network Management, ...",
            0x42: "BPDU (Bridge PDU / 802.1 Spanning Tree)",
            0x4E: "MMS (Manufacturing Message Service)",
            0x5E: "ISI IP",
            0x7E: "X.25 PLP (ISO 8208)",
            0x8E: "PROWAY (IEC 955) ASL Maintenance",
            0xAA: "SNAP (Sub-net Access Protocol)",
    ...
    def __init__(self, _bytes: bytes):
        ...
        if (len_or_type <= 1500):
            ...
            # 802.2 LLC                     0x____
            if (dsap_or_raw == "ffff"):
                self.eth_std = self.Eth_stds.NOVELL_802_3_RAW
        ...
        # LOGICAL LINK HEADER +
        # if (self.eth_std == self.Eth_stds.NOVELL_802_3_RAW):
